...
{ title:"Registration Closes", date:"Date will be announce on Monday" },
{ title:"Shortlisting Announcement", date:"Date will be announce on Monday" },
{ title:"Final Presentation", date:"Date will be announce on Monday" },
].map((event,index)=>{
